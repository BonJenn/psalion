      ...
      <section className="pt-2 md:pt-4 pb-0 md:pb-16 lg:pb-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 items-center">
            ...
            >
              <div className="relative w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-2xl h-[320px] sm:h-[460px] md:h-[560px] lg:h-[660px] overflow-hidden flex items-center justify-center">
                {isMobile ? (
