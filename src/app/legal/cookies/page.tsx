  ...
  return (
    <div className="pt-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <h1 className="text-3xl font-semibold text-gray-800 mb-8">Cookie Policy</h1>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Psalion Capital uses cookies to improve your experience on our website. We use cookies for the following purposes:
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Most browsers allow you to refuse cookies or delete them. You can usually find these settings in the options or preferences menu of your browser. For more information, please refer to your browser's help documentation.
            </p>

            <h3 className="text-xl font-medium text-gray-900 mb-3">Cookie Consent</h3>
            <p className="text-gray-600 leading-relaxed mb-4">
              When you first visit our website, you will be presented with a cookie consent banner. You can choose to accept or decline non-essential cookies. You can change your preferences at any time by clicking the cookie settings link in our website footer.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-600 mb-4 space-y-2">
              ...
              <li><strong>First-party cookies:</strong> Set by our website and typically retained for 1-2 years</li>
              <li><strong>Third-party cookies:</strong> Retention periods vary by the third-party service</li>
            </ul>
          </section>
