...
export default function NewsletterCTA({ source = '/mentions' }: { source?: string }) {
  ...
  return (
    <section className={`${isBespoke ? 'pt-0 md:pt-1 pb-4 md:pb-8 -mt-32 md:-mt-16' : 'pt-4 md:pt-6 pb-16 md:pb-24'} bg-gray-50`}>
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-b from-gray-50 to-gray-100 rounded-none">
          <div className={`flex flex-col items-start justify-center ${isBespoke ? 'gap-0 lg:gap-1 py-1 lg:py-2' : 'gap-2 lg:gap-3 py-8 lg:py-12'} max-w-6xl mx-auto`}>
