        ...
        <div className="bg-gradient-to-b from-gray-50 to-gray-100 rounded-none">
          <div className="flex flex-col lg:flex-row items-center justify-center gap-12 py-16">
            ...
            <div className="flex-1 w-full">
              {success ? (
                <div className="text-2xl md:text-4xl font-semibold text-gray-300 select-none">Thank you!</div>
              ) : (
                <form onSubmit={onSubmit} className="flex items-center border-b border-gray-300 pb-4 gap-3">
                  <input
                    ...
                    className="flex-1 bg-transparent placeholder-gray-300 text-gray-900 text-2xl md:text-3xl outline-none"
