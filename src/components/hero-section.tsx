          ...
          >
            <div className="relative w-full h-[400px] sm:h-[500px] md:h-[600px] lg:h-[700px] overflow-visible mx-auto lg:-translate-x-4 xl:-translate-x-6">
              ...
              <div className="absolute inset-0 pointer-events-none">
                ...
                <motion.a
                  href="/psalion-yield"
                  className="absolute top-[30%] sm:top-[44%] left-[58%] sm:left-[76%] md:left-[82%] lg:left-[84%] xl:left-[86%] 2xl:left-[88%] -translate-y-1/2 transform pointer-events-auto group"
                  initial={{ opacity: 0, scale: 0.8 }}
                  animate={{ opacity: 1, scale: 1 }}
