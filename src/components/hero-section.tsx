          ...
          >
            <div className="relative w-full h-[400px] sm:h-[500px] md:h-[600px] lg:h-[700px] overflow-visible mx-auto lg:-translate-x-20 xl:-translate-x-24 2xl:-translate-x-28">
              ...
              <div className="absolute inset-0 pointer-events-none z-20 overflow-visible">
                ...
                <motion.a
                  href="/psalion-yield"
                  className="absolute top-[22%] sm:top-[44%] left-[54%] sm:left-[68%] md:left-[74%] lg:left-[86%] xl:left-[88%] 2xl:left-[90%] -translate-y-1/2 transform pointer-events-auto group"
                  initial={{ opacity: 0, scale: 0.8 }}
                  animate={{ opacity: 1, scale: 1 }}
