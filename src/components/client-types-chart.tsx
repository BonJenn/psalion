        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mt-6 md:-mt-2">
          ...
          >
            ...
            >
              ...
              <svg width="600" height="600" viewBox="0 0 600 600" className="block transform rotate-0 w-full max-w-[400px] h-[400px] sm:max-w-[500px] sm:h-[500px] lg:w-[700px] lg:h-[700px]">
            ...
            <motion.h2
              className="w-full text-center -mt-2 sm:-mt-4 md:-mt-6 lg:-mt-16 xl:-mt-20 2xl:-mt-24 relative left-2 lg:-left-6 text-[10px] sm:text-xs md:text-sm font-medium text-gray-400 uppercase tracking-wide leading-none"
              style={{ fontFamily: 'IBM Plex Mono, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace' }}
              variants={fadeInUp}
